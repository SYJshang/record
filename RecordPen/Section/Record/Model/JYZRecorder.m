...
#define RecordFile [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject]
...
- (NSString *)filePath{
    ...
    NSString *recordedFile = [RecordFile stringByAppendingString:_recordName];
    return recordedFile;
}
