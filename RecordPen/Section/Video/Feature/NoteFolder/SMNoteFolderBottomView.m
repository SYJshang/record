...
//        [self.createBtn setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
        ...
        [self.createBtn setTitle:@"New File" forState:UIControlStateNormal];
...
- (UIButton *)createBtn {
    if (!_createBtn) {
        _createBtn = [UIButton at_createBtnWithTitle:@"New File" fontSize:15.0 titleColor:[UIColor at_goldColor] imgName:nil bgColor:nil addTarget:self selector:@selector(BottomViewBtnClicked:)];
